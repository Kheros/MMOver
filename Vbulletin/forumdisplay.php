...
$ad_location['ad_forumdisplay_afterthreads'] = vB_Template::create('ad_forumdisplay_afterthreads')->render();
...
$templater = vB_Template::create('FORUMDISPLAY');
	include_once DIR . '/vb/search/core.php';
	...
	$templater->register('contenttypeid', vB_Search_Core::get_instance()->get_contenttypeid('vBForum', 'Post'));
