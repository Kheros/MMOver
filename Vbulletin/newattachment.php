...
if ($_POST['do'] == 'manageattach')
{
	...
	{	// Attach file...
		...
		$uploadids = $attachlib->upload($vbulletin->GPC['attachment'], $vbulletin->GPC['attachmenturl'], $vbulletin->GPC['filedata']);
	...
	$templater = vB_Template::create('assetmanager');
		...
		$templater->register('auth_type', (
												...
												empty($_SERVER['REMOTE_USER'])
													AND
												$vbulletin->options['vbasset_enable']
													AND
												$vbulletin->userinfo['vbasset_enable']
											) ? 0 : 1);
