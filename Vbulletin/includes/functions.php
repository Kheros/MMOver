 ...
 */
function to_utf8($in, $charset = false)
{
...
function cache_calendar_permissions(&$user)
{
	...
	if (sizeof($membergroupids) == 1 OR
		!($vbulletin->usergroupcache["$USERGROUPID"]['genericoptions'] &
...
{
	global $vbulletin, $vbphrase, $stylecount;
