	...
	if ($db->num_rows($tags))
	{
		...
		<script type="text/javascript">
			...
			function js_show_synlist(trigger, listid)
			{
				...
				trigger.getElementsByTagName('img')[0].src = '../images/buttons/collapse_generic.gif';
				return false;
			}
			...
			function js_hide_synlist(trigger, listid)
			{
				...
				trigger.getElementsByTagName('img')[0].src = '../images/buttons/collapse_generic_collapsed.gif';
				return false;
			}
		</script>
		</form>
...
function tagcp_format_tag_entry($tag, $synonyms_in_list)
{
	...
	if (!$synonyms_in_list)
	{
		...
		if (count($synonyms))
		{
			...
			'<img src="../images/buttons/collapse_generic_collapsed.gif" />'.
			'</span>';
