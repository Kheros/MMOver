...
$ad_locations = array();	// $ad_locations[group_displayorder][group_key][location_displayorder][location_key][option(IE: cp_width, cp_height, etc.)] = value;
$ad_cache      = array();
$ad_name_cache = array();
