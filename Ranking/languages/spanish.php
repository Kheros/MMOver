...
$LNG['join_website'] = "Datos Servidor"; // 5.0
...
$LNG['lost_pw_get'] = "Enviar contraseña"; // 5.0
$LNG['lost_pw_emailed'] = "Por favor compruebe su correo para reiniciar su contraseña de aceso. Si no lo encuentra en la bandeja de entrada, revise también la bandeja de correo no deseado"; // 5.0
$LNG['lost_pw_email'] = "Para reiniciar su contraseña, visite la siguiente pagina:"; // 5.0
$LNG['lost_pw_new'] = "Introduce una nueva contraseña"; // 5.0
$LNG['lost_pw_set_new'] = "Fijar nueva contraseña"; // 5.0
$LNG['lost_pw_finish'] = "Nueva contraseña fijada. Ya puede iniciar sesión."; // 5.0
...
// Rate and Review
$LNG['rate_header'] = "Votar";
$LNG['rate_message'] = "Por favor, introduzca la puntuación para %s a continuacion."; // 5.2.0
$LNG['rate_rating'] = "Votación";
$LNG['rate_review'] = "Comentario.(Dejar en blanco si no quiere comentar)"; // 5.0
$LNG['rate_thanks'] = "¡Gracias por votar este sitio!";
$LNG['rate_error'] = "Ya has votado de este sitio.";
$LNG['rate_back'] = "Regresar a Estadísticas";
$LNG['rate_email_admin'] = "Un nuevo comentario ha sido escrito en su top."; // 5.1.0
