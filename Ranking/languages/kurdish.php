...
$translation = 'Kurdish (کوردی)';
$translator_name = 'سیڤان';
$translator_email = 'sevansg@hotmail.com';
$translator_url = 'http://kurdchat.newsit.es';

// Set this to the character encoding of your translation
$LNG['charset'] = "utf-8";

// Global
$LNG['g_form_submit_short'] = "بڕۆ";
$LNG['g_username'] = "ناوی به‌کارهێنه‌ر";
$LNG['g_url'] = "به‌سته‌ری ماڵپه‌ڕ";
$LNG['g_title'] = "ناوی ماڵپه‌ڕ";
$LNG['g_description'] = "ده‌رباره‌ی";
$LNG['g_category'] = "به‌ش"; // 4.1.0
$LNG['g_email'] = "پۆستی ئه‌لکترۆنی";
$LNG['g_banner_url'] = "به‌سته‌ری باننێر";
$LNG['g_password'] = "ووشه‌ی نهێنی";
$LNG['g_average'] = "مامناوه‌ند";
$LNG['g_today'] = "ئه‌مڕۆ";
$LNG['g_yesterday'] = "دوێنێ";
$LNG['g_daily'] = "ڕۆژانه‌"; // 5.0
$LNG['g_this_month'] = "ئه‌م مانگه‌"; // 5.0
$LNG['g_last_month'] = "مانگی پێشوو"; // 5.0
$LNG['g_monthly'] = "مانگانه‌"; // 5.0
$LNG['g_this_week'] = "ئه‌م حه‌فته‌یه‌"; // 5.0
$LNG['g_last_week'] = "حه‌فته‌ی پێشوو"; // 5.0
$LNG['g_weekly'] = "هه‌فتانه‌"; // 5.0
$LNG['g_pv'] = 'بینینه‌کان'; // 5.0
$LNG['g_overall'] = 'گشتی'; // 5.0
$LNG['g_in'] = 'ده‌نگ'; // 5.0
$LNG['g_out'] = ''; // 5.0
$LNG['g_unq_pv'] = "بینینی نوێ"; // 5.0
$LNG['g_tot_pv'] = "کۆی بینینه‌کان"; // 5.0
$LNG['g_unq_in'] = "ده‌نگه‌ ڕاسته‌قینه‌کان"; // 5.0
$LNG['g_tot_in'] = "کۆی ده‌نگه‌کان"; // 5.0
$LNG['g_unq_out'] = "سه‌ردانیسه‌ردانی نوێ"; // 5.0
$LNG['g_tot_out'] = "کۆی سه‌ردانه‌کان"; // 5.0
$LNG['g_invalid_u_or_p'] = "ناوی به‌کارهێنه‌ر یان ووشه‌ی تێپه‌ڕبوون هه‌ڵه‌یه‌،تکایه‌ جارێکیکه‌ هه‌وڵ بده‌ره‌وه‌."; // 5.0
$LNG['g_invalid_u'] = "ناوی به‌کارهێنه‌ر ڕاست نیه‌ ،تکایه‌ هه‌وڵ بده‌ره‌وه‌."; // 5.0
$LNG['g_invalid_p'] = "ووشه‌ی نهێنی هه‌ڵه‌یه‌ ،تکایه‌ هه‌وڵبده‌ره‌وه‌."; // 5.0
$LNG['g_session_expired'] = "ماوه‌ی هاتنه‌ژووره‌وه‌ت به‌سه‌رچوو،تکایه‌ جارێیکه‌ بچۆره‌ژووره‌وه‌."; // 5.0
$LNG['g_error'] = "نامه‌ی به‌ڕێوبه‌ر"; // 5.0
$LNG['g_delete_install'] = "يجب أن تقوم بحذف ملف التثبيت install.php قبل تشغيل البرنامج."; // 5.0
$LNG['g_ip'] = "ژماره‌ی ئای پی"; // 5.2.0

// Edit Account
$LNG['edit_header'] = "چاکسازی ماڵپه‌ڕ";
$LNG['edit_info_edited'] = "ماڵپه‌ڕه‌که‌ به‌سه‌رکه‌وتویی چاککرا.";
$LNG['edit_password_blank'] = "به‌ به‌تاڵی به‌جێی بێڵه‌ بۆ پاراستنی وشه‌ نهێنییه‌که‌ی ئێستات"; // 4.0
$LNG['edit_delay'] = "چاکسازییه‌کانت قبوڵ ده‌کرێت پاش بینینی له‌لایه‌ن به‌ڕێوبه‌ره‌وه‌"; // 5.2.0

// Gateway Page
$LNG['gateway_header'] = "ڕۆشتن بۆ لاپه‌ڕه‌ی سه‌ره‌کی";
$LNG['gateway_text'] = "بۆڕێگه‌ گرتن له‌ خه‌ش،لاپه‌ره‌که‌ هه‌ڵگیرا تکایه‌ کلیک له‌ لینکی خواره‌وه‌ بکه‌ بۆ چوون بۆ لاپه‌ڕه‌ی سه‌ره‌کی.";
$LNG['gateway_vote'] = "چونه‌ژووره‌وه‌ و ده‌نگ دان";
$LNG['gateway_no_vote'] = "چوونه‌ژووره‌وه‌ به‌بێ ده‌نگ"; // 5.0
...
// Join
$LNG['join_header'] = "چونه‌ژوره‌وه‌";
$LNG['join_enter_text'] = "أدخل النص كما تراه في الصورة أدناه:"; // 4.2.2
$LNG['join_enter_text_read'] = "لا تستطيع القراءة"; // 5.2.0
$LNG['join_user'] = "ئه‌ندام"; // 5.0
$LNG['join_website'] = "ماڵپه‌ڕ"; // 5.0
$LNG['join_banner_size'] = "(گه‌وره‌ترین قه‌باره‌  %sx%s)"; // 5.2.0
$LNG['join_error_username'] = "ناوێکی ڕاست بنوسه‌:ده‌توانی پیته‌کان،ژماره‌کان،شه‌فت و پیته‌کان. به‌کار بێنیت."; // 5.0
$LNG['join_error_username_duplicate'] = "ئه‌م ناوه‌ پێشتر تۆمارکراوه‌."; // 5.0
$LNG['join_error_url'] = "به‌سته‌ری ماڵپه‌ڕه‌که‌ به‌شێوه‌یه‌کی ڕاست بنوسه‌.";
$LNG['join_error_email'] = "پۆستی ئه‌لکترۆنی ڕاست بنوسه‌.";
$LNG['join_error_title'] = "ناوی ماڵپه‌ڕه‌که‌ بنوسه‌.";
$LNG['join_error_password'] = "ووشه‌ی نهێنی بنوسه‌.";
$LNG['join_error_confirm_password'] = "ووشه‌ی نهێنی وه‌ک یه‌ک نیه‌"; // 5.2.0
$LNG['join_error_urlbanner'] = "به‌سته‌ری لۆگۆکه‌ت بنوسه‌،به‌به‌تاڵی به‌جێی بێڵه‌ ئه‌گه‌ر لۆگۆت نیه‌"; // 5.2.0
$LNG['join_error_time'] = "په‌ڕه‌که‌ نوێ مه‌که‌ره‌وه‌."; // 4.2.0
$LNG['join_error_captcha'] = "وه‌ڵامه‌که‌ت هه‌ڵه‌یه‌"; // 4.2.2
$LNG['join_error_question'] = "وه‌ڵامه‌که‌ت هه‌ڵه‌یه‌ ."; // 5.2.0
$LNG['join_thanks'] = "سوپاس بۆ بوونت به‌ ئه‌ندام  ! ئه‌م کۆده‌ کۆپیبکه‌ره‌ لاپه‌ڕه‌ی سه‌ره‌کی ئه‌و ماڵپه‌ڕه‌ی لامان تۆمار کراوه‌.";
$LNG['join_change_warning'] = "هه‌رگۆڕانکارییه‌ک له‌م کۆده‌ ده‌بێته‌ هۆی له‌کارخستنی.";
$LNG['join_welcome'] = "به‌خێربێیت بۆ %s";
$LNG['join_welcome_admin'] = "ئه‌ندامێکی نوێ هاته‌ پێشبڕکێ که‌وه‌.";
$LNG['join_approve'] = "شكرا لانضمامكم سوف يدرج موقعكم في السباق بعد موافقة المشرف عليه . في هذه الاثناء سيصلكم بريد ببقية المعلومات الضرورية لتفعيل موقعكم "; // 5.2.0
$LNG['join_type'] = "جۆری ئه‌ندام"; // 5.1.0
$LNG['join_standard'] = "ئاسایی"; // 5.1.0
$LNG['join_error_top'] = "هه‌ڵه‌یه‌ک ڕووییاوه‌ تکایه‌ هه‌وڵ بده‌ره‌وه‌"; // 5.2.0
$LNG['join_ban_top'] = "اشتراك يحتوي على بيانات محظورة من قبل مشرف الموقع"; // 5.2.0
$LNG['join_security'] = "ئاسایش"; // 5.2.0
$LNG['join_confirm_password'] = "دڵنیاکردنه‌وه‌ی وشه‌ی ێپه‌ڕبوون"; // 5.2.0

// Link Code
$LNG['link_code_header'] = "کۆدی هه‌ڵبژاردن"; // 5.0

// Lost Password
$LNG['lost_pw_header'] = "ووشه‌ی تێپه‌ڕبوونم له‌بیر کردووه‌"; // 5.0
$LNG['lost_pw_forgot'] = "ووشه‌یتێپه‌ڕ بوونت له‌بیرکردووه‌؟"; // 5.0
$LNG['lost_pw_get'] = "گێرانه‌وه‌ی ووشه‌ی تێپه‌ڕبوون"; // 5.0
$LNG['lost_pw_emailed'] = "تکایه‌ بڕۆ سندوقی پۆسته‌ ئه‌لکترۆنییه‌که‌ت و  دوای زانیارییه‌کان بکه‌وه‌."; // 5.0
$LNG['lost_pw_email'] = "بۆگۆڕینی وشه‌ی نهێنی کلیک له‌م لینکه‌ بکه‌:"; // 5.0
$LNG['lost_pw_new'] = "ووشه‌ی نهێنی نوێ بنووسه‌"; // 5.0
$LNG['lost_pw_set_new'] = "دووباره‌ ووشه‌ی نهێنی بنووسه‌ره‌وه‌"; // 5.0
$LNG['lost_pw_finish'] = "ووشه‌ی نهێنییه‌که‌ت گۆڕڕا به‌سه‌ر که‌وتوویی."; // 5.0

// Main Page
$LNG['main_header'] = "ڕێکخستن"; // 5.0
$LNG['main_all'] = "بینینی هه‌مووی"; // 4.2.0
$LNG['main_method'] = "سفرردنه‌وه‌ی پێشبڕکێ";
$LNG['main_members'] = "ژماره‌ی ماڵپه‌ڕه‌کان";
$LNG['main_menu_rankings'] = "لاپه‌ره‌ی سه‌ره‌کی";
$LNG['main_menu_join'] = "ماڵپه‌ڕه‌که‌ت زیاد بکه‌";
$LNG['main_menu_random'] = "هه‌رجارێک ماڵپه‌ڕێک";
$LNG['main_menu_search'] = "گه‌ڕان";
$LNG['main_menu_lost_code'] = "کۆدی ده‌نگدان"; // 5.0
$LNG['main_menu_lost_password'] = "ووشه‌ی تێپه‌ڕبوون"; // 5.0
$LNG['main_menu_edit'] = "چاکسازی ماڵپه‌ڕ";
$LNG['main_menu_user_cp'] = "چونه‌ژوره‌وه‌ی ئه‌ندام"; // 5.0
$LNG['main_featured'] = "هه‌رجارێک ماڵپه‌ڕێک"; // 4.0.2
$LNG['main_executiontime'] = "زۆرترین ماوه‌ی کارکردن"; // 4.0
$LNG['main_queries'] = "SQL Queries"; // 4.0
$LNG['main_powered'] = "Powered by";

// Ranking Table
$LNG['table_stats'] = "ئامار";
$LNG['table_unique'] = "ئێستا";
$LNG['table_total'] = "کۆی گشتی";
$LNG['table_rank'] = "ڕێکخستن";
$LNG['table_title'] = "ماڵپه‌ڕ"; // 4.0
$LNG['table_description'] = "ده‌رباره‌"; // 4.0
$LNG['table_movement'] = "گۆڕانکاری";
$LNG['table_up'] = "له‌ زیاد بوون دایه‌"; // 5.0
$LNG['table_down'] = "له‌ که‌مبوون دایه‌"; // 5.0
$LNG['table_neutral'] = "ئاسایی"; // 5.0
$LNG['table_your_site_here'] = "ماڵپه‌ڕه‌که‌ت لێره‌دانێ"; // 5.2.0

// Rate and Review
$LNG['rate_header'] = "ده‌نگدان و بینین";
$LNG['rate_message'] = "تکایه‌ ڕای خۆت بۆ ئه‌م ماڵپه‌ڕه‌ لێره‌ بنوسه‌  %s له‌م بۆشاییه‌ی خواره‌وه‌."; // 5.2.0
$LNG['rate_rating'] = "هه‌ڵسه‌نگاندنه‌کان";
$LNG['rate_review'] = "ڕاو سه‌رنج - HTML کار ناکات"; // 5.0
$LNG['rate_thanks'] = "سوپاس بۆ ده‌نگه‌که‌ت.";
$LNG['rate_error'] = "پێشتر ده‌نگت بۆ ئه‌م ماڵپه‌ڕه‌ یاوه‌.";
$LNG['rate_back'] = "گه‌ڕانه‌وه‌ بۆ ئاماره‌کان";
$LNG['rate_email_admin'] = "A new review has been posted at your topsites list"; // 5.1.0

// Search
$LNG['search_header'] = "گه‌ڕان";
$LNG['search_off'] = "گه‌ڕان له‌کار خراوه‌ له‌لایه‌ن به‌ڕێوبه‌ر.";
$LNG['search_no_sites'] = "ببوره‌ گه‌ڕآنه‌که‌ت ئه‌نجامی نه‌بوو"; // 5.0
$LNG['search_prev'] = "پێشوو"; // 3.2.1
$LNG['search_next'] = "داهاتوو"; // 3.2.1
$LNG['search_displaying_results'] = "بینین %s بۆ %s له‌ %s ئه‌نجامی تایبه‌ت به‌ <b>%s</b>."; // 5.1.0

// Stats
$LNG['stats_header'] = "ئاماره‌کان";
$LNG['stats_info'] = "زانیاری";
$LNG['stats_member_since'] = "ئه‌ندامه‌ له‌"; // 5.0
$LNG['stats_rating_avg'] = "مامناوه‌ندی ده‌نگه‌کان";
$LNG['stats_rating_num'] = "ژماره‌ی ده‌نگه‌کان";
$LNG['stats_rate'] = "ڕاوسه‌رنج و ده‌نگدان له‌سه‌ر ماڵپه‌ڕ";
$LNG['stats_reviews'] = "بینینه‌کان";
$LNG['stats_allreviews'] = "بینینی هه‌موی"; // 4.0
$LNG['stats_week'] = "هه‌فته‌"; // 5.0
$LNG['stats_highest'] = "به‌رزترین"; // 5.0
$LNG['stats_overall'] = "کۆی گشتی"; // 5.2.0
$LNG['stats_overall_average'] = "ناوه‌ند (لانیکه‌م 10 % "; // 5.2.0
$LNG['stats_overall_total'] = "کۆیگشتی(هه‌مووی)"; // 5.2.0

// ssi.php
$LNG['ssi_top'] = "تۆپ %s 10"; // 4.0
$LNG['ssi_new'] = "%s نوێترین"; // 5.0
$LNG['ssi_all'] = "هه‌مووماڵپه‌ڕه‌کان"; // 4.0

// User Control Panel // 5.0
$LNG['user_cp_header'] = "به‌شی چاکسازییه‌کانی ئه‌ندام"; // 5.0
$LNG['user_cp_login'] = "چوونه‌ژوره‌وه‌"; // 5.0
$LNG['user_cp_logout'] = "چوونه‌ده‌ره‌وه‌"; // 5.0
$LNG['user_cp_welcome'] = "به‌خێربێیت بۆ به‌شیتایبه‌ت به‌ چاکسازییه‌کانی ئه‌ندام،به‌سته‌ره‌کان به‌کار بێنه‌ بۆ چاکسازییه‌کانت"; // 5.0
$LNG['user_cp_logout_message'] = "چویته‌ده‌ره‌وه‌ له‌ به‌شی چاکسازی به‌سه‌رکه‌وتویی"; // 5.0
$LNG['user_cp_login_long'] = "چوونه‌ژووره‌وه‌ به‌هۆی ناوو ووشه‌ی نهێنی یان ناسنامه‌ی کراوه‌ OpenID"; // 5.1.0
$LNG['user_cp_openid'] = "ناسنامه‌ی کراوه‌"; // 5.1.0
$LNG['user_cp_openid_error_server'] = "نه‌توانرا سێرڤه‌ری ناسنامه‌ی کراوه‌ بدۆزرێته‌وه‌ %s."; // 5.1.0
$LNG['user_cp_openid_error_join'] = "پێویسته‌ ببیت به‌ ئه‌ندام بۆ به‌کارهێنانی ئه‌م چاکسازییانه‌"; // 5.1.0
$LNG['user_cp_openid_error_general'] = "یه‌کێک له‌م هه‌ڵانه‌ ڕوییاوه‌ ،تکایه‌ هه‌وڵ بده‌ره‌وه‌."; // 5.1.0
$LNG['user_cp_openid_error_cancel'] = "پێویسته‌ مافت هه‌بێت بۆ گه‌یشتن به‌م لاپه‌ڕه‌یه‌،تکایه‌ هه‌وڵ بده‌ره‌وه‌."; // 5.1.0
$LNG['user_cp_openid_error_from_server'] = "هه‌ڵه‌ له‌ سێرڤه‌ره‌وه‌یه‌: %s"; // 5.1.0
$LNG['user_cp_inactive'] = "ناتوانیت بچیته‌‌ ژووره‌وه‌ هه‌تا ماڵپه‌ڕه‌که‌ت له‌لایه‌ن به‌ڕێوبه‌ره‌وه‌ ڕێگه‌ی پێده‌درێت"; // 5.0.2
