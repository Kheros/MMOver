...
//Esa linea da la imagen de base que estoy usando//
$img = imagecreatefrompng("{$CONF['path']}/images/ranking.png");
             //Definimos los colores para las letras que salgan//

//color1= Color azul, lo que sale despues de definir las variables//
$color1 = imagecolorallocate($img, 255, 153, 0);
//color2= Color blanco, el Nº que sale en rango//
$color2 = imagecolorallocate($img, 255, 255, 255);
//Esta linea avisa al navegador que va a ver una imagen solamente//
header ("Content-type: image/png");
//El valor de "2" es el tamaño de las letras, luego el siguiente valor son las coordenadas en px de X y de Y//
...
imagestring($img, 11, 126 - ((strlen($TMPL['rank']) - 1) * 4), 20, $TMPL['rank'], $color2);
imagepng($img);
?>
