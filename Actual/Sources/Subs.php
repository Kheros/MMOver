...
{
	global $context, $modSettings, $user_info, $txt, $scripturl;        global $settings;
		...
		$buttons = array(
			...
			'admin' => array(
				...
				'sub_buttons' => array(
					...
					'packages' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/box.png" alt="'.$txt['package']. '"/>&nbsp; ' . $txt['package'],
						'href' => $scripturl . '?action=admin;area=packages',
						'show' => allowedTo('admin_forum'),
					),
					'errorlog' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/bug.png" alt="'.$txt['errlog']. '"/>&nbsp; ' . $txt['errlog'],
						'href' => $scripturl . '?action=admin;area=logs;sa=errorlog;desc',
						'show' => allowedTo('admin_forum') && !empty($modSettings['enableErrorLogging']),
					),
					'permissions' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/user_edit.png" alt="'.$txt['edit_permissions']. '"/>&nbsp; ' . $txt['edit_permissions'],
			...
			'moderate' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/star.png" alt="'.$txt['moderate']. '"/>&nbsp; ' . $txt['moderate'],
				'href' => $scripturl . '?action=moderate',
				'show' => $context['allow_moderation_center'],
				'sub_buttons' => array(
					'modlog' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/report.png" alt="'.$txt['modlog_view']. '"/>&nbsp; ' . $txt['modlog_view'],
						'href' => $scripturl . '?action=moderate;area=modlog',
						'show' => !empty($modSettings['modlog_enabled']),
					),
					'poststopics' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/pencil_delete.png" alt="'.$txt['mc_unapproved_poststopics']. '"/>&nbsp; ' . $txt['mc_unapproved_poststopics'],
						'href' => $scripturl . '?action=moderate;area=postmod;sa=posts',
						'show' => $modSettings['postmod_active'],
					),
					'attachments' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/photo_delete.png" alt="'.$txt['mc_unapproved_attachments']. '"/>&nbsp; ' . $txt['mc_unapproved_attachments'],
						'href' => $scripturl . '?action=moderate;area=attachmod;sa=attachments',
						'show' => $modSettings['postmod_active'],
					),
					'reports' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/report_edit.png" alt="'.$txt['mc_reported_posts']. '"/>&nbsp; ' . $txt['mc_reported_posts'],
			...
			'profile' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/user.png" alt="'.$txt['profile']. '"/>&nbsp; ' . $txt['profile'],
				'href' => $scripturl . '?action=profile',
				'show' => $context['allow_edit_profile'],
				'sub_buttons' => array(
					'summary' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/arrow_rotate_clockwise.png" alt="'.$txt['summary']. '"/>&nbsp; ' . $txt['summary'],
						'href' => $scripturl . '?action=profile',
						'show' => true,
					),
					'account' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/application.png" alt="'.$txt['account']. '"/>&nbsp; ' . $txt['account'],
						'href' => $scripturl . '?action=profile;area=account',
						'show' => allowedTo(array('profile_identity_any', 'profile_identity_own', 'manage_membergroups')),
					),
					'profile' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/user_edit.png" alt="'.$txt['forumprofile']. '"/>&nbsp; ' . $txt['forumprofile'],
			...
			'pm' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/email.png" alt="'.$txt['pm_short']. '"/>&nbsp; ' . $txt['pm_short'],
				'href' => $scripturl . '?action=pm',
				'show' => $context['allow_pm'],
				'sub_buttons' => array(
					'pm_read' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/email_open.png" alt="'.$txt['pm_menu_read']. '"/>&nbsp; ' . $txt['pm_menu_read'],
						'href' => $scripturl . '?action=pm',
						'show' => allowedTo('pm_read'),
					),
					'pm_send' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/email_edit.png" alt="'.$txt['pm_menu_send']. '"/>&nbsp; ' . $txt['pm_menu_send'],
			...
			'calendar' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/date.png" alt="'.$txt['calendar']. '"/>&nbsp; ' . $txt['calendar'],
				'href' => $scripturl . '?action=calendar',
				'show' => $context['allow_calendar'],
				'sub_buttons' => array(
					'view' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/date_go.png" alt="'.$txt['calendar_menu']. '"/>&nbsp; ' . $txt['calendar_menu'],
						'href' => $scripturl . '?action=calendar',
						'show' => allowedTo('calendar_post'),
					),
					'post' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/date_edit.png" alt="'.$txt['calendar_post_event']. '"/>&nbsp; ' . $txt['calendar_post_event'],
			...
			'mlist' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/group.png" alt="'.$txt['members_title']. '"/>&nbsp; ' . $txt['members_title'],
				'href' => $scripturl . '?action=mlist',
				'show' => $context['allow_memberlist'],
				'sub_buttons' => array(
					'mlist_view' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/user_go.png" alt="'.$txt['mlist_menu_view']. '"/>&nbsp; ' . $txt['mlist_menu_view'],
						'href' => $scripturl . '?action=mlist',
						'show' => true,
					),
					'mlist_search' => array(
						'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/user_comment.png" alt="'.$txt['mlist_search']. '"/>&nbsp; ' . $txt['mlist_search'],
			...
			'login' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/key.png" alt="'.$txt['login']. '"/>&nbsp; ' . $txt['login'],
			...
			'register' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/key_add.png" alt="'.$txt['register']. '"/>&nbsp; ' . $txt['register'],
			...
			'logout' => array(
				'title' => '<img align="absMiddle" src="'. $settings['images_url']. '/menu_icons/delete.png" alt="'.$txt['logout']. '"/>&nbsp; ' . $txt['logout'],
