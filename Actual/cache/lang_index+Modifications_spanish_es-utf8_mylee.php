...
$forum_copyright = '<a href="http://www.simplemachines.org/" title="Simple Machines Forum" target="_blank" class="new_win">Powered by %1$s</a> | <a href="http://www.simplemachines.org/about/copyright.php" title="Free Forum Software" target="_blank" class="new_win">SMF &copy; 2006&ndash;2009, Simple Machines LLC</a>';
...
//Member Color Link
$txt['MemberColorLinkHeadline'] = 'Colores de miembros';
$txt['MemberColorLink'] = 'La vista del &iacute;ndice de temas';
$txt['MemberColorLinkOldSpanStyle'] = 'Usar etiqueta html span para el color (Viejo estilo del Mod)';
$txt['MemberColorThreadOwner'] = 'El creador del tema en el &iacute;ndice del foro';
$txt['MemberColorThreadLastPost'] = 'El miembro del &uacute;ltimo mensaje en el &iacute;ndice de mensajes';
$txt['MemberColorThreadChild'] = 'El miembro del &uacute;ltimo mensaje en los subforos';
$txt['MemberColorModeratorLinks'] = 'Colorear los enlaces de moderador';
$txt['MemberColorBoardindex'] = 'El miembro del &uacute;ltimo mensaje en el &iacute;ndice de foros';
$txt['MemberColorBirthday'] = 'Los enlaces de cumplea&ntilde;os de los miembros (Calendario e &Iacute;ndice de foros)';
$txt['MemberColorRecentOwner'] = 'Mensajes recientes, creador del tema';
$txt['MemberColorRecentLastPost'] = 'Mensajes recientes, &uacute;ltimo publicador';
$txt['MemberColorInbox'] = 'Cambiar colores en la bandeja de Recibidos en Mensajes privados';
$txt['MemberColorOutbox'] = 'Cambiar colores en la bandeja de Enviados en Mensajes privados';
$txt['MemberColorLatestMember'] = 'Colorear al &uacute;ltimo miembro';
$txt['MemberColorStats'] = 'Cambiar color en las estad&iacute;sticas del foro.';
$txt['MemberColorWhoIsOnline'] = 'Colorear el Qui&eacute;n está en l&iacute;nea (&Iacute;ndice de mensajes e &Iacute;ndice de temas)';
$txt['MemberColorGuests'] = 'Color para los nicks de visitantes<br /><span class="smalltext">&Iacute;ndice de foros, de mensajes y vista del tema</span>';
$txt['MemberColorBanned'] = 'Color para los nicks de baneados';
$txt['MemberColorBirthdayColor'] = 'Color para los nicks de cumplea&ntilde;eros';
...
$txt['MemberColorAllSearch'] = 'Extender color en Buscar a todos los campos (Necesaria mucha carga)';
$txt['youtube'] = 'YouTube';
