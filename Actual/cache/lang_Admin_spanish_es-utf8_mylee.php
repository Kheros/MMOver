...
$txt['copyright_ends_in'] = 'Su subscripción para quitar el copyright de SMF termina en <b>%1$s</b> dís.';
$txt['copyright_click_renew'] = 'Click <a href="http://www.simplemachines.org/copyright/renew.php?key=%1$s" style="color: red;">aquí</a> para renovar';
$txt['copyright_removal'] = 'Quitar Copyright';
$txt['copyright_removal_desc'] = 'Para quitar el copyright de su instalación necesitará el código obtenido de la web Simple Machines. Si aún no ha obtenido un código por favor haga clic <a href="http://www.simplemachines.org/copyright/index.php">aquí</a>. Una vez que el código se ha introducido y comprobado el copyright será ocultado hasta que su subscripción expire. El tiempo restante será mostrado en el centro de Administración.';
$txt['copyright_code'] = 'Código del Copyright';
